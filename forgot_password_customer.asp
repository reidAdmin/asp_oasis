  ...
  <!--DWLayoutTable-->
	...
	<tr>
		...
		<td colspan="8" rowspan="2" valign="top" bgcolor="#000033"><table width="100%"  border="0" cellspacing="2" cellpadding="2">
          <tr>
            <td class="text2"><img src="images/customer_login.jpg" width="178" height="27"></td>
          </tr>
          <tr>
            <td height="176" valign="top" class="text">
			  <form name="RForm" action="recover_password_customer.asp" method="post" onSubmit="JavaScript:return validateform()">
			  <table cellpadding="2" cellspacing="0" border="0" width="100%">
			    <tr>
				  <td colspan="2" class="text">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Please use this form to recover your Username/Password.</td></tr>
				<tr>
				...
				<tr>
				  ...
				  <td><input type="text" name="Company" size="30"></td></tr>
				<tr>
