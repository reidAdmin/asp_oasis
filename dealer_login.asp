...
<META NAME="description" CONTENT="Oasis Car Wash Systems Dealer Login for Investment Opportunity, Car Wash Equipment, Car Wash Service Equipment, Car Wash Equipment Options, New Car Wash Developments Also, oasis car wash investment dealer login,oasis car wash investment opportunity dealer login,car wash dealer login,investment opportunities car wash dealer login,typhoon car wash dealer login,typhoon xp car wash dealer login,jetstream car wash dealer login,mirage car wash dealer login,oasis galeforce dealer login,galeforce carwash dryer dealer login,oasis vehicle care wash dealer login,oasis touchless car wash dealer login,oasis car wash systems manufacturer phone number,carwash equipment dealer login and high pressure wash dealer login.">
<META NAME="keywords" CONTENT="oasis car wash investment dealer login,oasis car wash investment opportunity dealer login,car wash dealer login,investment opportunities car wash dealer login,typhoon car wash dealer login,typhoon xp car wash dealer login,jetstream car wash dealer login,mirage car wash dealer login,oasis galeforce dealer login,galeforce carwash dryer dealer login,oasis vehicle care wash dealer login,oasis touchless car wash dealer login,oasis car wash systems manufacturer phone number,carwash equipment dealer login,high pressure wash dealer login">
		...
		<td colspan="8" rowspan="2" valign="top" bgcolor="#000033"><table width="100%"  border="0" cellspacing="2" cellpadding="2">
          ...
          <tr>
            <td height="176" valign="top" class="text" align="center">
			  <form name="LoginForm" action="validate.asp" method="post">
			  <table cellpadding="2" cellspacing="0" border="0">
				...
				<tr>
				  <td>&nbsp;</td>
				  <td align="center" class="text"><a href="forgot_password_dealer.asp"><font size="1">Forgot Username/Password?</font></a></td></tr>
				<tr>
				  <td colspan="2"><br></td></tr>
				<tr>
				  <td>&nbsp;</td>
