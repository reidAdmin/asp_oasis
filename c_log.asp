  ...
  <!--DWLayoutTable-->
	...
	<tr>
		...
		<td colspan="8" rowspan="2" valign="top" bgcolor="#000033"><table width="100%"  border="0" cellspacing="2" cellpadding="2">
          <tr>
            <td class="text2">
			<img src="images/customer_login.jpg" width="178" height="27"></td>
          </tr>
          <tr>
            <td height="176" valign="top" class="text" align="center">
			  <form name="LoginForm" action="validate_customer.asp" method="post">
			  <p><b><font size="2">IMPORTANT!</font><br>
				YOU MUST REGISTER YOUR EQUIPMENT IN ORDER TO OBTAIN A USERNAME 
				AND PASSWORD.<br>
				<a href="product_registration.asp"><font size="2">PLEASE CLICK 
				HERE TO GO TO THE EQUIPMENT REGISTRATION FORM.</font></a></b></p>
			  <table cellpadding="2" cellspacing="0" border="0">
				...
				<tr>
				  <td>&nbsp;</td>
				  <td align="center" class="text"><font size="1">
					<a href="forgot_password_customer.asp">Forgot Username/Password?</a></font></td></tr>
				<tr>
				  <td colspan="2"><br></td></tr>
				<tr>
				  <td>&nbsp;</td>
